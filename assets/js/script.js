...
function openCity(evt, cityName) {
  ...
  evt.currentTarget.className += " active__link-recipe";
}
...
$(".icon-favorite").on("click", function (event) {
  var img1 = "/assets/img/Icon-fav.png";
  var img2 = "/assets/img/Icon-fav-act.png";
