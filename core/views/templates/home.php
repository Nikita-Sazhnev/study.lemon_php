...
<div class="login__singin-group d-flex justify-content-center align-items-start flex-wrap mt-lg-3 mt-1 mb-3 mb-lg-5">
        ...
        <form>
            ...
            <div class="form-group form-check">
                <div class="forgot__sring d-flex justify-content-between">
                    ...
                    <label class="form-check-label" for="exampleCheck1" style="font-size: 0.7rem; color: gray;">Remember
                        me</label>
                    <a class="forgon__link" href="#">Forgot your password</a>
                </div>
            </div>
            ...
            <div class="dont__have-acc d-flex justify-content-center mt-2">
                <a href="#" class="m-0" style="font-size: 1rem; color: gray;">Don`t have an accont? Sing
                    In</a>
            </div>
        </form>
    </div>
    <div class="singin__form col-9 col-md-5 col-sm-7 col-lg-3 my-2 col-3 mx-5 bg-white py-3 px-4 shadow__box">
