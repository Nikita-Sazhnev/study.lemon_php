...
<div class="singin__form col-9 col-md-5 col-sm-7 col-lg-3 my-4 col-3 bg-white py-3 px-4 shadow__box mx-auto">
    ...
    <form method="POST" action="#">
        ...
        <div class="form-group">
            <input name="login" type="text" class="form-control form__input btn-outline-light" id="exampleInputEmail1"
        ...
        <div class="form-group">
            <input name="password_confirm" type="password" class="form-control form__input btn-outline-light"
                id="exampleInputPassword2" placeholder="repeat password">
        </div>
        <div class="button__contein d-flex justify-content-center">
            <input type="submit" class="btn btn-sm btn-outline-dark px-4 pt-2 pb-1 my-1 text-uppercase"
